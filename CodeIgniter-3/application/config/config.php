...
//Api Url
$config['google_api_url'] = "https://maps.googleapis.com/maps/api/geocode/json";
$config['google_api_key'] = 'AIzaSyDbqQPgVDl24o8C9r7AVxd5OKv_YINn_mQ';

define('base' , "http://localhost/CodeIgniter-3/");
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
